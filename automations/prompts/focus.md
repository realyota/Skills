You are running a focused, read-only ClickHouse audit using the modular skills under:
`altinity-expert-clickhouse/skills/`

Mode: conditional (focused)
Focus skill: ${AUDIT_FOCUS_SKILL}
...
Start with the focus skill above. Then decide which additional skills to load based on findings.
